...
import com.androidlearning.boris.familycentralcontroler.fragment01.base.DiskContentAdapter;
...
import com.androidlearning.boris.familycentralcontroler.fragment01.utils.*;
import com.androidlearning.boris.familycentralcontroler.fragment02.audioSetActivity;
import com.androidlearning.boris.familycentralcontroler.fragment02.imageLibActivity;
...
public class diskTVContentActivity extends Activity implements View.OnClickListener, NetBroadcastReceiver.netEventHandler {
    ...
    private static com.androidlearning.boris.familycentralcontroler.fragment01.utils.TVFileHelper TVFileHelper;
    ...
    public static com.androidlearning.boris.familycentralcontroler.fragment01.utils.TVFileHelper getTVFileHelper() {
        return TVFileHelper;
    }
                ...
                if (fileBeanClick.type == FileTypeConst.folder) {
                    ...
                    if (fileBeanClick.type == FileTypeConst.pic && MyApplication.isSelectedTVOnline()){//是视频则可以播放
                        new Thread(new Runnable() {
                            @Override
                            public void run() {
                                com.androidlearning.boris.familycentralcontroler.fragment01.utils.prepareDataForFragment.getDlnaCastState(fileBeanClick,"image");
                            }
                        }).start();
                    }else {
